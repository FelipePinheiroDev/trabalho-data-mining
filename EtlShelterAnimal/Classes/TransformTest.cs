...
namespace EtlShelterAnimal.Classes
{
    ...
    public sealed class TransformTest : CsvClassMap<InputData>
    {
        public TransformTest()
        {
            ...
            {
                string value = r.GetField<string>(4);
            ...
            {
                string value = r.GetField<string>(7);
